...
My research interest lies in the intersection of remote sensing, machine learning, agriculture, and environmental sustainability. My research leverages multi-scale remote sensing, field data collection, and advanced computational modeling methods to better understand ecosystem dynamics. Specifically, my recent works have been focusing on near real-time crop characterization (e.g., crop type mapping, crop phenology forecasting), spatiotemporal fusion of multi-scale remote sensing data, and understanding climate change impacts on agricultural systems.
